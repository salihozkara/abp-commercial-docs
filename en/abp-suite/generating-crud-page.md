...
*  **Concurrency check:** Implements `IHasConcurrencyStamp` interface for the entity. This is always implemented if the base class is `AggregateRoot`. For more details see the [Concurrency check documentation](https://docs.abp.io/en/abp/latest/Concurrency-Check).
